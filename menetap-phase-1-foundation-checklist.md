...
- [x] Add the shared footer to the search-results page.
- [x] Implement EN/ID language-prefixed public paths and preserve query parameters during language switching.
...
- [x] Add a Surabaya-specific 1600×1200 WebP Tugu Pahlawan image for the destination directory, with descriptive alternative text.
...
- [x] Replace the generic Bantul landscape image with a craft-focused destination image and descriptive alternative text.
